...
Servicio de software puro (ML/analítica) - sin hardware/firmware/os propios, podados de la plantilla (ver convención del ecosistema en `SONNET/_papelera/`).
...
├── tests/                   # pytest - correccion de FFT, estadistica del baseline, deteccion real de fallos
