@echo off
REM =============================================================================
REM HYDRA-UMC-ANOMALY-DETECTOR - build.bat
REM Copyright (C) 2026 JuanenRac (Electro Hobby 3D) <electrohobby3d@gmail.com>
REM GPL-3.0 - see LICENSE
REM =============================================================================
REM Builds HYDRA-UMC-ANOMALY-DETECTOR: creates/activates a venv, installs
...
echo.
echo  ===============================================================
echo   H Y D R A - U M C - A N O M A L Y - D E T E C T O R  -  build
echo  ===============================================================
echo   AI-driven predictive maintenance (FFT / vibration analysis)
...
python -m py_compile src\hydra_umc_anomaly_detector\__init__.py src\hydra_umc_anomaly_detector\main.py
if errorlevel 1 goto :error
python -c "import hydra_umc_anomaly_detector; print('import OK - version', hydra_umc_anomaly_detector.__version__)"
if errorlevel 1 goto :error
echo       Done.
echo.
