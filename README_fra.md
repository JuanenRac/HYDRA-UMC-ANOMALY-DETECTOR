...
Service purement logiciel (ML/analytique) - sans hardware/firmware/os propres, retirés du template (voir la convention de l'écosystème dans `SONNET/_papelera/`).
